            ...
            <div class="rg_center">
                <div class="rg_form">
                    <form action="#" method="post">
                        <table>
                            <tr>
                                <td class="td_left">氏名漢字<span class="str">必須</span> </td>
                                <td class="td_right"><b>大郎</b></td>
                            </tr>
                            <tr>
                                <td class="td_left">希望職種<span class="str">必須</span> </td>
                                <td class="td_right"><b>Java開発</b></td>
                            </tr>
                            <tr>
                                <td class="td_left">希望給与<span class="str">必須</span> </td>
                                <td class="td_right"><b>17K</b></td>
                            </tr>
                            <tr>
                                <td class="td_left">希望勤務地<span class="str">必須</span> </td>
                                <td class="td_right"><b>東京</b> </td>

                            <tr>
                                <td class="td_left">電話番号<span class="str">必須</span> </td>
                                <td class="td_right"><b>123121</b> </td>
                            </tr>

                            <tr>
                                <td class="td_left">メ ール<span class="str">必須</span> </td>
                                <td class="td_right"><b>１２３１２３１@323.jp</b> </td>
                            </tr>
                            <tr>
                                <td class="td_left">その他<span class="str">　　</span> </td>
                                <td class="td_right">
                                    <b>23232</b>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="2" align="center">
                                    ...
                                    <div style="float: left; padding-left: 30PX; padding-top: 10PX;">
                                        <input type="submit" value="閉める" id="btn_sub2">
                                    </div>
                                </td>
                            </tr>
                        </table>
