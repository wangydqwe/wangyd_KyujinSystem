...
<script type = "text/javascript">
    window.onload = function() {
        ...
        let kojin = '${kyushoku.kojinName}';
        let yakuShoku = '${kyushoku.yakuShokuName}';
        let kyuyo = '${kyushoku.kyoyu}';
        let kinmuchi = '${kyushoku.jusho1}';
        let tele = '${kyushoku.tele}';
        let mail = '${kyushoku.mail}';
        let biko = '${kyushoku.biko}';
        //old
        let oldkojin = '${oldKyushoku.kojinName}';
        let oldyakuShoku = '${oldKyushoku.yakuShokuName}';
        let oldkyuyo = '${oldKyushoku.kyoyu}';
        let oldkinmuchi = '${oldKyushoku.jusho1}';
        let oldtele = '${oldKyushoku.tele}';
        let oldmail = '${oldKyushoku.mail}';
        let oldoldbiko = '${oldKyushoku.biko}';
        if (kojin !== oldkojin){
                ...
                <div class="rg_form">
                    <form method="post">
                        ...
                        <tr>
                            ...
                            <td class="td_right" id="t1"><input type="text" name="KojinName" id="KojinName" value="${kyushoku.kojinName}" readonly>${kyushoku.kojinName}</td>
                        </tr>
                        <tr>
                            <td class="td_left"><label for="yakuShoku">　希望職種　</label></td>
                            <td class="td_right" id="t2"><input type="text" name="YakuShokuName" id="yakuShoku" value="${kyushoku.yakuShokuName}" readonly>${kyushoku.yakuShokuName}</td>
                        </tr>
                        <tr>
                            <td class="td_left"><label for="kyuYu">　希望給与　</label></td>
                            <td class="td_right" id="t3"><input type="text" name="Kyoyu" id="kyuYu" value="${kyushoku.kyoyu}" readonly>${kyushoku.kyoyu}</td>
                        </tr>
                        <tr>
                            <td class="td_left"><label for="kinMuChi">希望勤務地　</label></td>
                            <td class="td_right" id="t4"><input type="text" name="Jusho1" id="kinMuChi" value="${kyushoku.jusho1}" readonly>${kyushoku.jusho1}</td>
                        <tr>
                            <td class="td_left"><label for="tele">　電話番号　</label></td>
                            <td class="td_right" id="t5"><input type="text" name="Tele" id="tele" value="${kyushoku.tele}" readonly>${kyushoku.tele}</td>
                        </tr>

                            <tr>
                                <td class="td_left"><label for="email">  メール</label></td>
                                <td class="td_right" id="t6"><input type="email" name="Mail" id="email" value="${kyushoku.mail}" readonly>${kyushoku.mail}</td>
                            </tr>
                            <tr>
