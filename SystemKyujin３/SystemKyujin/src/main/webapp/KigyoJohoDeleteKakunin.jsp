                    ...
                    <form method="post">
                        ...
                        <table>
                            <tr>
                                ...
                                <td class="td_right"><input type="text" name="KaishaName" id="KaishaName" value="${kyujin.kaishaName}" readonly>${kyujin.kaishaName}</td>
                            </tr>
                            <tr>
                                <td class="td_left"><label for="yakuShoku">　職種　</label></td>
                                <td class="td_right"><input type="text" name="YakuShokuName" id="yakuShoku" value="${kyujin.yakuShokuName}"readonly>${kyujin.yakuShokuName}</td>
                            </tr>
                            <tr>
                                <td class="td_left"><label for="kyuYu">　給与　</label></td>
                                <td class="td_right"><input type="text" name="Kyoyu" id="kyuYu" value="${kyujin.kyoyu}" readonly>${kyujin.kyoyu}</td>
                            </tr>
                            <tr>
                                <td class="td_left"><label for="kinMuChi">勤務地　</label></td>
                                <td class="td_right"><input type="text" name="Jusho1" id="kinMuChi" value="${kyujin.jusho1}" readonly>${kyujin.jusho1}</td>
                            <tr>
                                <td class="td_left"><label for="tele">電話番号</label></td>
                                <td class="td_right"><input type="text" name="Tele" id="tele" value="${kyujin.tele}" readonly>${kyujin.tele}</td>
                            </tr>

                            <tr>
                                <td class="td_left"><label for="email"> メール　</label></td>
                                <td class="td_right"><input type="email" name="Mail" id="email" value="${kyujin.mail}" readonly>${kyujin.mail}</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td colspan="2" align="center">
                                    <div style="float: left; padding-left: 500PX; padding-top: 10PX;">
                                        <input type="submit" value="戻る" id="btn_sub1" formaction="${pageContext.request.contextPath}/kyujinList/deleteModoru/${rtype}">
                                    </div>
                                    <div style="float: left; padding-left: 30PX; padding-top: 10PX;">
                                        <input type="submit" value="削除" id="btn_sub2" formaction="${pageContext.request.contextPath}/kyujinList/deleteKyujin/${rtype}">
                                    </div>
