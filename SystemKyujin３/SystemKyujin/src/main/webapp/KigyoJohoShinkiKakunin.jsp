                    ...
                    <form method="post">
                        <table>
                            <tr>
                                ...
                                <td class="td_right"><input type="text" name="KaishaName" id="KaishaName" value="${kyujin.kaishaName}">${kyujin.kaishaName}</td>
                            </tr>
                            <tr>
                                <td class="td_left"><label for="yakuShoku">　職種　</label></td>
                                <td class="td_right"><input type="text" name="YakuShokuName" id="yakuShoku" value="${kyujin.yakuShokuName}">${kyujin.yakuShokuName}</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td colspan="2" align="center">
                                    <div style="float: left; padding-left: 500PX; padding-top: 10PX;">
                                        <input type="submit" value="戻る" id="btn_sub1" formaction="${pageContext.request.contextPath}/kyujinList/addKauninModoru/${rtype}">
                                    </div>
                                    <div style="float: left; padding-left: 30PX; padding-top: 10PX;">
                                        <input type="submit" value="新規" id="btn_sub2" formaction="${pageContext.request.contextPath}/kyujinList/addKakunin/${rtype}" >
                                    </div>
