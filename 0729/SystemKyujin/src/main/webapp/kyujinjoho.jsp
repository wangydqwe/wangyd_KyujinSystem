    ...
    <div class="container_12">
        ...
        <form id="form1">
            ...
            <span style="margin-left: 800PX; ">
                   <input  id="button1" type="submit" value="変更" formaction="${pageContext.request.contextPath}/kyujinList/updateKakunin" onclick="subForm(this)" style="width: 80PX; height: 20PX; background-color: lightskyblue;"/>
		     	</span>
            <span>
                   <input id="button2" type="submit" value="削除" formaction="${pageContext.request.contextPath}/kyujinList/deleteKyujin" onclick="subForm(this)" style="width: 80PX; height: 20PX; background-color: lightskyblue;" />
			    </span>
        </form>
        <section id="main">
