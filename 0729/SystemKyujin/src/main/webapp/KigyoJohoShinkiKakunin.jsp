...
<header>
    <div class="container_12">
        ...
        <div class="rg_layout">
            ...
            <div class="rg_center">
                <div class="rg_form">
                    <form action="${pageContext.request.contextPath}/kyujinList/addKakunin" method="post">
                        <table>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td class="td_right">
                                    <textarea id="biKo" name="Biko" style="width: 400PX; border:  2px solid #A6A6A6; border-radius: 5px; padding-left: 10px;" readonly >${kyujin.biko}</textarea>
                                </td>
                            </tr>
                            <tr>
