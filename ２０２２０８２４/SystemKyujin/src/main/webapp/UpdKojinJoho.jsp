...
<header>
    <div class="container_12">
        ...
        <div class="rg_layout">
            <div class="rg_left">
                <h2>個人情報変更</h2>
                <span id="e1" style="color: red;display: block">${errorInfo.KojinName}</span>
                <span id="e2"style="color: red;display: block">${errorInfo.YakuShokuName}</span>
                <span id="e3"style="color: red;display: block">${errorInfo.Kyoyu}</span>
                <span id="e4"style="color: red;display: block">${errorInfo.Jusho1}</span>
                <span id="e5"style="color: red;display: block">${errorInfo.Tele}</span>
                <span id="e6"style="color: red;display: block">${errorInfo.Mail}</span>
                    ...
                    <form method="post">
                        ...
                        <table>
                            <tr>
                                ...
                                <td class="td_right"><input type="text" name="KojinName" id="shimeiKanji" value="${kyushoku.kojinName}"> </td>
                            </tr>
                            <tr>
                                <td class="td_left"><label for="kihonShokushu">　希望職種　</label><span class="str">必須</span> </td>
                                <td class="td_right"><input type="text" name="YakuShokuName" id="kihonShokushu" onfocus="" value="${kyushoku.yakuShokuName}"> </td>
                            </tr>
                            <tr>
                                <td class="td_left"><label for="Kyoyu">　希望給与　</label><span class="str">必須</span> </td>
                                <td class="td_right"><input type="text" name="Kyoyu" id="kyoyu" onfocus="" value="${kyushoku.kyoyu}"> </td>
                            </tr>
                            <tr>
                                <td class="td_left"><label for="kimuchi">希望勤務地　</label><span class="str">必須</span> </td>
                                <td class="td_right"><input type="text" name="Jusho1" id="kimuchi" onfocus="" value="${kyushoku.jusho1}"> </td>
                            ...
                            <tr>
                                <td class="td_left"><label for="email"> メ ー ル　</label><span class="str">必須</span> </td>
                                <td class="td_right"><input type="email" name="Mail" id="email" value="${kyushoku.mail}" readonly style="border: none;display:none">${kyushoku.mail}</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td colspan="2" align="center">
                                    <div style="float: left; padding-left: 600PX; padding-top: 10PX;">
                                        <input type="submit" value="戻る" id="btn_sub1" formaction="${pageContext.request.contextPath}/list/updateModoru/${rtype}">
                                    </div>
                                    <div style="float: left; padding-left: 30PX; padding-top: 10PX;">
                                        <input type="submit"  value="変更" id="btn_sub2" formaction="${pageContext.request.contextPath}/list/henkouKakunin/${rtype}">
                                    </div>
