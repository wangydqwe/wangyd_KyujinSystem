                ...
                <div class="rg_form">
                    <form method="post">
                        ...
                        <table>
                            ...
                            <tr>
                                <td class="td_left"><label for="Kyoyu">　給与　</label><span class="str">必須</span> </td>
                                <td class="td_right"><input type="text" name="Kyoyu" id="Kyoyu" value="${kyujin.kyoyu}" > </td>
                            </tr>
                            <tr>
                                <td class="td_left"><label for="kimuchi">勤務地　</label><span class="str">必須</span> </td>
                                <td class="td_right"><input type="text" name="Jusho1" id="kimuchi" value="${kyujin.jusho1}" > </td>
                            ...
                            <tr>
                                ...
                                <td class="td_right"><input type="email" name="Mail" id="email" value="${kyujin.mail}" readonly style="border: none;display:none">${kyujin.mail}</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td colspan="2" align="center">
                                    <div style="float: left; padding-left: 600PX; padding-top: 10PX;">
                                        <input type="submit" value="戻る" id="btn_sub1" formaction="${pageContext.request.contextPath}/kyujinList/updateModoru/${rtype}">
                                    </div>
                                    <div style="float: left; padding-left: 30PX; padding-top: 10PX;">
                                        <input type="submit"  value="変更" id="btn_sub2" formaction="${pageContext.request.contextPath}/kyujinList/henkouKakunin/${rtype}">
                                    </div>
