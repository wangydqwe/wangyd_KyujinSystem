                    ...
                    <form method="post">
                        <table>
                            <tr>
                                ...
                                <td class="td_right"><input type="text" name="KojinName" id="KojinName" value="${kyushoku.kojinName}">${kyushoku.kojinName}</td>
                            </tr>
                            <tr>
                                <td class="td_left"><label for="yakuShoku">　希望職種　</label></td>
                                <td class="td_right"><input type="text" name="YakuShokuName" id="yakuShoku" value="${kyushoku.yakuShokuName}">${kyushoku.yakuShokuName}</td>
                            </tr>
                            <tr>
                                <td class="td_left"><label for="kyuYu">　希望給与　</label></td>
                                <td class="td_right"><input type="text" name="Kyoyu" id="kyuYu" value="${kyushoku.kyoyu}" >${kyushoku.kyoyu}</td>
                            </tr>
                            <tr>
                                <td class="td_left"><label for="kinMuChi">希望勤務地　</label></td>
                                <td class="td_right"><input type="text" name="Jusho1" id="kinMuChi" value="${kyushoku.jusho1}" >${kyushoku.jusho1}</td>
                            <tr>
                                <td class="td_left"><label for="tele">　電話番号　</label></td>
                                <td class="td_right"><input type="text" name="Tele" id="tele" value="${kyushoku.tele}" >${kyushoku.tele}</td>
                            </tr>

                            <tr>
                                <td class="td_left"><label for="email"> イー メ ール　</label></td>
                                <td class="td_right"><input type="email" name="Mail" id="email" value="${kyushoku.mail}" >${kyushoku.mail}</td>
                            </tr>
                            <tr>
                                <td class="td_left"><label for="biKo">その他　</label></td>

                                <td class="td_right">
                                    <textarea id="biKo" name="biKo" style="width: 400PX; padding-left: 10px;" readonly >${kyushoku.biko}</textarea>
                                    ${kyushoku.biko}
                                </td>
                            </tr>
                            <tr>
                                <td colspan="2" align="center">
                                    <div style="float: left; padding-left: 500PX; padding-top: 10PX;">
                                        <input type="submit" value="戻る" id="btn_sub1" formaction="${pageContext.request.contextPath}/list/addKauninModoru/${rtype}">
                                    </div>
                                    <div style="float: left; padding-left: 30PX; padding-top: 10PX;">
                                        <input type="submit" value="新規" id="btn_sub2" formaction="${pageContext.request.contextPath}/list/addKakunin/${rtype}">
                                    </div>
